    ...
    while i < ldf:
        if TF == mt5.TIMEFRAME_M1 or TF == mt5.TIMEFRAME_H1 or TF == mt5.TIMEFRAME_M15:
            ...
            if rates_frame['RSI3'][i] < 13 and rates_frame['closeup'][i] < rates_frame['ema50up'][i] and \
                ...
                i] < rates_frame['ema20upupup'][i] or rates_frame['closeupupupup'][i] < rates_frame['ema50upupupup'][i] and rates_frame['closeupupupup'][
                i] < rates_frame['ema20upupupup'][i]):
                flag_rsi3r_n = i
        else:
            if rates_frame['RSI3'][i] < 13 and rates_frame['closeup'][i] < rates_frame['ema50up'][i] and \
                    rates_frame['closeup'][i] < rates_frame['ema20up'][i] \
...
currencys = ['EURUSD', 'GBPUSD', 'USDCAD', 'USDJPY', 'GOLD', 'WTI', '#USSPX500', '#USNDAQ100', '#US30', '#Germany30',
             '#Euro50',
